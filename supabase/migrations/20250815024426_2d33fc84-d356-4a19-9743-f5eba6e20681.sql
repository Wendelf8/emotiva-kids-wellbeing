-- Corrigir as políticas RLS para normalizar a comparação do tipo_usuario
...
-- Também vamos normalizar os dados existentes na tabela profiles
UPDATE public.profiles 
SET tipo_usuario = LOWER(TRIM(tipo_usuario)) 
WHERE tipo_usuario IS NOT NULL;

-- Adicionar um trigger para normalizar automaticamente futuros inserts/updates
